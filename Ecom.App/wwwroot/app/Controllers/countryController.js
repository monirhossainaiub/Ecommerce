...
app.controller("countryController", ($scope, $http, $rootScope, httpRequestService, messageService, baseService) =>
{
    //server controller name
    var controllerName = "country";
    $scope.dataTableName = "Countries";
    var FormPopUp = "FormPopUp";
    var entityNameToPerform = "country";
    $scope.isExist = false;
